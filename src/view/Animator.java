...
public class Animator {
    ...
    GUIDesign design = Singleton.getDs();
        ...
        for (c = 0; c < design.junk.size(); c++) {
            ...
            if ((c % 2) == 0){//GOES LEFT
                ...
                design.junk.get(c).relocate(design.junk.get(c).getLayoutX() - 
                        g/Junk.getSpeedFactor(), design.junk.get(c).getLayoutY());
            }else{//GOES RIGHT
            ...
            //cadrage Y 
            if (design.junk.get(c).getLayoutY() >= Junk.getMaxY()+1+Junk.getBumpFactor()) {
                design.junk.get(c).setDirection(Junk.Direction.UP);
            }else if (design.junk.get(c).getLayoutY() <= Junk.getMinY()-1-Junk.getBumpFactor()) {
                design.junk.get(c).setDirection(Junk.Direction.DOWN);
            }
            if (design.junk.get(c).getDirection()==Junk.Direction.UP){
                design.junk.get(c).setLayoutY(design.junk.get(c).getLayoutY()-d-Junk.getBumpFactor()); 
...
//            }
    ...
    void setCarAnimation(){
        ...
        if (design.cars.get(a).getLayoutY() > 526) {
            design.cars.get(a).relocate(-a * Car.getBumperOffset(), 326);
        }

        else if (design.cars.get(a).getLayoutY() < 326) {
            design.cars.get(a).relocate(-a * Car.getBumperOffset(), 326);
        }else
            design.cars.get(a).relocate(design.cars.get(a).getLayoutX() + design.cars.get(a).getSpeed(), design.cars.get(a).getLayoutY());
        }
