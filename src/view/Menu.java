...
public class Menu {
    ...
    public Menu(GUIManager gm,GUIDesign design,Graphics gr){
        this.gr=gr;
        this.design=design;
        this.GUIMan=gm;
    }
    ...
    */
    public StackPane setMenuPanel() {
        ...
        this.design.getHbMid().setAlignment(Pos.CENTER);
        this.design.getHbMid().getChildren().clear();
    ...
    public void setScoresDisplay(ArrayList<Game> games){
