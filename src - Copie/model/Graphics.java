...
public class Graphics {
    ...
    public Image frog1_Img = new Image("img/frogs/frog30_1.png");
    public Image frog2_Img = new Image("img/frogs/frog30_2.png");
    public Image frog3_Img = new Image("img/frogs/frog30_3.png");
    public Image frog4_Img = new Image("img/frogs/frog30_4.png");
    ...
    public ImageView frog_1 = new ImageView(frog1_Img);
    public ImageView frog_2 = new ImageView(frog2_Img);
    public ImageView frog_3 = new ImageView(frog3_Img);
    public ImageView frog_4 = new ImageView(frog4_Img);
